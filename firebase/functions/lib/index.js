...
exports.processInviteAccepted = exports.acceptInvite = exports.notifyInviteCreated = exports.sendInvite = void 0;
const admin = require("firebase-admin");
const functions = require("firebase-functions");
const crypto = require("crypto");
admin.initializeApp();
const db = admin.firestore();
const inviteUrlBase = functions.config().app?.invite_url || process.env.INVITE_URL || "https://shoply.app/invite";
...
exports.sendInvite = publicCallable(async (data, context) => {
...
exports.notifyInviteCreated = functions.firestore
...
exports.acceptInvite = publicCallable(async (data, context) => {
...
exports.processInviteAccepted = functions.firestore
